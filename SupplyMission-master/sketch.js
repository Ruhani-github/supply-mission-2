...
function setup() {
	...
	//Create a Ground
	boxb = Bodies.rectangle (390,650,200,20,{isStatic:true});
World.add(world,boxb);
	ground = Bodies.rectangle(width/2, 650, width, 10 , {isStatic:true} );
	 World.add(world, ground);
	 boxl = Bodies.rectangle (300,610,20,100,{isStatic:true});
	 World.add(world,boxl);

boxr = Bodies.rectangle (480,610,20,100,{isStatic:true});
